...
namespace RT_Rimtroid
{
    class LaserBeamGraphic :Thing
    {
        ...
        void SetColor(Thing launcher)
        {
            ...
            if (launcher is Pawn pawn && pawn.equipment != null) gun = pawn.equipment.Primary as IBeamColorThing;
        ...
        public override void SpawnSetup(Map map, bool respawningAfterLoad)
        {
            ...
            foreach (var decoration in projDef.decorations)
            {
                ...
                while (length > 0)
                {
                    if (!(ThingMaker.MakeThing(decoration.mote, null) is MoteLaserDecoration moteThrown)) break;
